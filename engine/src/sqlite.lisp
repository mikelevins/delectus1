...
;;; GENERIC FUNCTION valid-sqlite-file? ((path pathname))
;;; ---------------------------------------------------------------------
;;; returns true if PATH names a valid SQLite file
...
;;; (sqlite-list-table-column-info "/Users/mikel/Workshop/src/delectus/test-data/Movies.delectus2" "contents")
;;; returns NIL because there is no such table:
;;; (sqlite-list-table-column-info "/Users/mikel/Workshop/src/delectus/test-data/Movies.delectus2" "foo")
...
;;; (sqlite-list-table-column-names "/Users/mikel/Workshop/src/delectus/test-data/Movies.delectus2" "contents")
;;; returns NIL because there is no such table:
;;; (sqlite-list-table-column-names "/Users/mikel/Workshop/src/delectus/test-data/Movies.delectus2" "foo")
