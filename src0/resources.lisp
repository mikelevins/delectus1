...
(defmethod init-resources ()
  ...
  #+cocoa(define-resource :images :add-hl-button (resource "addhl.png"))
  #+win32(define-resource :images :add-hl-button (resource "addhl.bmp"))
  #+cocoa(define-resource :images :del-button (resource "del.png"))
  #+win32(define-resource :images :del-button (resource "del.bmp"))
  #+cocoa(define-resource :images :del-hl-button (resource "delhl.png"))
  #+win32(define-resource :images :del-hl-button (resource "delhl.bmp"))
  ...
  #+cocoa(define-resource :images :trashfull-button (resource "trashfull32.png"))
  #+win32(define-resource :images :trashfull-button (resource "trashfull32.bmp"))
  )
