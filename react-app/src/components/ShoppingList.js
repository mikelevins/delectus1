...
class ShoppingList extends React.Component {
    ...
    // shopping list items, so this component is pure UI.
    ...
    render() {
        ...
        let items = this.props.shoppingListItems.map(
            (item) =>  <div key={'listitem_'+item._id}>

                <ListItem
            className='shoppinglistitem'
            primaryText={<span className={(item.checked ? 'checkeditem' : 'uncheckeditem')}>
                         {item.title}
                         </span>} 
