;;; oleg's string-search utils from
;;; http://okmij.org/ftp/Scheme/util.html#string-search
;;; from the site banner at: http://okmij.org/ftp/README.html:
...
;;; crude but sufficient -- mle 09/07/23
