...
. The userdata columns in one list are unique, completely different from the userdata columns in any other list.
...
From that point, the number, names, and contents of the userdata columns and items are controlled by the user.
