...
Two different copies of the same list may have different `origin` values. The `origin` records the identity of the node that maintains this copy of the list, not the identity of the node where it was first created.
