...
var len__4730__auto___10304 = arguments.length;
var i__4731__auto___10305 = (0);
while(true){
if((i__4731__auto___10305 < len__4730__auto___10304)){
args__4736__auto__.push((arguments[i__4731__auto___10305]));

var G__10306 = (i__4731__auto___10305 + (1));
i__4731__auto___10305 = G__10306;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10301){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10302,G__10303,seq10301__$2);
});
...
var vec__10307 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__10307,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__10307,(1),null);
var G__10310 = cljs.core.PersistentArrayMap.EMPTY;
var G__10310__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10310,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10310);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10310__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10310__$1;
}
} else {
...
return (function() { 
var G__10314__delegate = function (klass,contents){
var vec__10311 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10311,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10311,(1),null);
...
var G__10314 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__10315__i = 0, G__10315__a = new Array(arguments.length -  1);
while (G__10315__i < G__10315__a.length) {G__10315__a[G__10315__i] = arguments[G__10315__i + 1]; ++G__10315__i;}
  contents = new cljs.core.IndexedSeq(G__10315__a,0,null);
} 
return G__10314__delegate.call(this,klass,contents);};
G__10314.cljs$lang$maxFixedArity = 1;
G__10314.cljs$lang$applyTo = (function (arglist__10316){
var klass = cljs.core.first(arglist__10316);
var contents = cljs.core.rest(arglist__10316);
return G__10314__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10320){
...
var ns = cljs.core.get.call(null,map__10321__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__10321__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10323){
var map__10324 = p__10323;
var map__10324__$1 = (((((!((map__10324 == null))))?(((((map__10324.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10324.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10324):map__10324);
var actual = cljs.core.get.call(null,map__10324__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10324__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10326){
...
var expected = cljs.core.get.call(null,map__10327__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10327__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__10329_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10331 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__10331__$1;
var name = cljs.core.get.call(null,map__10331__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__10331__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10331__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__10331,map__10331__$1,info,name,line,file,node){
return (function (p1__10330_SHARP_){
return cljs.core.cons.call(null,node,p1__10330_SHARP_);
});})(curr_node,map__10331,map__10331__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10333){
...
var fail = cljs.core.get.call(null,map__10334__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10334__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10334__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10334__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___10336 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10336)){
var message_10337 = temp__5457__auto___10336;
cljs.core.println.call(null,message_10337);
} else {
}
...
var temp__5457__auto___10338 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10338)){
var message_10339 = temp__5457__auto___10338;
cljs.core.println.call(null,message_10339);
} else {
}
